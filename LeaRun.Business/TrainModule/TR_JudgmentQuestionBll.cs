...
{
    public class TR_JudgmentQuestionBll : RepositoryFactory<TR_JudgmentQuestion>
    {
            ...
            string QuestionDescripe,string SkillType, string SkillID)
        {
            ...
            strSql.Append(@" select a.*,b.skillname,b.skilltype from TR_JudgmentQuestion a left join TR_Skill b on a.SkillID=b.SkillID where 1=1   ");
