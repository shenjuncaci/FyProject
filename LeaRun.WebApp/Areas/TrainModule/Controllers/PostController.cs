...
namespace LeaRun.WebApp.Areas.TrainModule.Controllers
{
    ...
    {
        RepositoryFactory<TR_Post> repositoryfactory = new RepositoryFactory<TR_Post>();
        TR_PostBll PostBll = new TR_PostBll();
        //
        ...
        [HttpPost]
        public ActionResult SubmitForm(string KeyValue, TR_Post entity, string BuildFormJson, HttpPostedFileBase Filedata)
        {
        ...
        {
            TR_Post entity = DataFactory.Database().FindEntity<TR_Post>(KeyValue);
            if (entity == null)
            {
                return Content("");
            }
        ...
        public ActionResult TypeJson()
        {
            string sql = " select Code,FullName from Base_DataDictionaryDetail where DataDictionaryId='c4a69509-4068-43d4-b344-57cc72ab5cb9'  ";
