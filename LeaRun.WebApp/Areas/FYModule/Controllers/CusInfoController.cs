...
namespace LeaRun.WebApp.Areas.FYModule.Controllers
{
    ...
    {
        RepositoryFactory<FY_CusInfo> repositoryfactory = new RepositoryFactory<FY_CusInfo>();
        FY_CusInfoBll CusBll = new FY_CusInfoBll();
        //
        ...
        [HttpPost]
        public ActionResult SubmitForm(string KeyValue, FY_CusInfo entity, string BuildFormJson, HttpPostedFileBase Filedata)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Base_DataScopePermissionBll.Instance.AddScopeDefault(ModuleId, ManageProvider.Provider.Current().UserId, entity.CusInfoID, isOpenTrans);
                }
                Base_FormAttributeBll.Instance.SaveBuildForm(BuildFormJson, entity.CusInfoID, ModuleId, isOpenTrans);
                database.Commit();
        ...
        {
            FY_CusInfo entity = DataFactory.Database().FindEntity<FY_CusInfo>(KeyValue);
            if (entity == null)
            {
                return Content("");
            }
        ...
        public void WriteLog(int IsOk, string KeyValue, string Message = "")
        {
            ...
            Base_SysLogBll.Instance.WriteLog<FY_CusInfo>(array, IsOk.ToString(), Message);
        }
    }
}
