...
namespace LeaRun.WebApp.Areas.FYModule.Controllers
{
    ...
    {
        RepositoryFactory<FY_ChangeData> repositoryfactory = new RepositoryFactory<FY_ChangeData>();
        FY_ChangeDataBll ChangeDataBll = new FY_ChangeDataBll();
        //
        ...
        public ActionResult GridPageListJson(string keywords, string CompanyId, string DepartmentId, JqGridParam jqgridparam, string ParameterJson)
        {
            try
            {
                ...
                DataTable ListData = ChangeDataBll.GetPageList(keywords, ref jqgridparam, ParameterJson);
                var JsonData = new
                {
        ...
        [HttpPost]
        public ActionResult SubmitForm(string KeyValue, FY_ChangeData entity, string BuildFormJson, HttpPostedFileBase Filedata)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    Base_DataScopePermissionBll.Instance.AddScopeDefault(ModuleId, ManageProvider.Provider.Current().UserId, entity.ChangeDataID, isOpenTrans);
                }
                Base_FormAttributeBll.Instance.SaveBuildForm(BuildFormJson, entity.ChangeDataID, ModuleId, isOpenTrans);
                database.Commit();
        ...
        {
            FY_ChangeData entity = DataFactory.Database().FindEntity<FY_ChangeData>(KeyValue);
            if (entity == null)
            {
                return Content("");
            }
